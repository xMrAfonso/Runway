 ...
 *
 * @property hookHandler The [HookHandler] instance for checking available hooks.
 * @property configHandler The [ConfigHandler] instance for accessing configuration settings.
 */
